...
public final class BlogDao_Impl implements BlogDao {
  ...
  public BlogDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfBlogCacheEntity = new EntityInsertionAdapter<BlogCacheEntity>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `blogs` (`id`,`title`,`body`,`category`,`image`) VALUES (?,?,?,?,?)";
      }
  ...
  @Override
  public Object get(final Continuation<? super List<BlogCacheEntity>> p0) {
    final String _sql = "SELECT * FROM blogs";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.execute(__db, false, new Callable<List<BlogCacheEntity>>() {
      @Override
      public List<BlogCacheEntity> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new BlogCacheEntity(_tmpId,_tmpTitle,_tmpBody,_tmpCategory,_tmpImage);
            _result.add(_item);
          }
          return _result;
        } finally {
